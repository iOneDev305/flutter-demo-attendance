class SampleSingleObjectRequestModel {
  final int id;
  ...
  SampleSingleObjectRequestModel({
    required this.id,
  ...
  factory SampleSingleObjectRequestModel.fromJson(Map<String, dynamic> json) {
    return SampleSingleObjectRequestModel(
      id: json['id'] ?? 0,
